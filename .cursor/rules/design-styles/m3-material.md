...
- **Fallback**: if no verified Unsplash image is available, use a **tonal surface placeholder** from the Material color scheme rather than a broken or mismatched image.
